...
close(figureh);
    ...
    % end
else params = zeros(1,13); cutOffDates(1) = 0; resnorm(1) = 0;
    residual{1} = 0; jacobian{1} = 0; modelT = zeros(size(dataT));
    modelY = zeros(size(dataY)); initGuess = params; initGuessY = ...
        modelY;
end
